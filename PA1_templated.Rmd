...
hist(sumsteps[,2],main="Histograme of total steps per day",xlab="Total Steps",col="blue")
...
hist(tsteps$total_steps,main="Histograme of total steps per day",xlab="Total Steps",col="gi")
